      ...
      try {
        ...
        try {
          ...
          const demoTalent: TalentProfile = {
            ...
            bio: "Passionate full-stack developer with 8+ years of experience building scalable web applications. I specialize in React, Node.js, and cloud architecture. I love creating intuitive user experiences and robust backend systems that help businesses grow.",
            hourly_rate: 85,
            ...
            skills: [
              { id: '1', name: 'React', level: 'expert', proficiency: 'expert', years_experience: 6, is_visible: true },
              { id: '2', name: 'Node.js', level: 'expert', proficiency: 'expert', years_experience: 7, is_visible: true },
              { id: '3', name: 'TypeScript', level: 'advanced', proficiency: 'advanced', years_experience: 5, is_visible: true },
              { id: '4', name: 'Python', level: 'intermediate', proficiency: 'intermediate', years_experience: 3, is_visible: true },
              { id: '5', name: 'AWS', level: 'advanced', proficiency: 'advanced', years_experience: 4, is_visible: true },
              { id: '6', name: 'Docker', level: 'intermediate', proficiency: 'intermediate', years_experience: 3, is_visible: true }
            ],
            ...
            portfolio: [
              {
                ...
                description: 'Built a full-stack e-commerce platform handling 10k+ daily users',
                technologies: ['React', 'Node.js', 'PostgreSQL', 'AWS'],
                live_url: 'https://example-ecommerce.com',
                github_url: 'https://github.com/alexj/ecommerce',
                image_url: ''
              }
            ],
            profile_visibility: {
